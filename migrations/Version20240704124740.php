 ...
 */
final class Version20240704124740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(64) NOT NULL, password VARCHAR(128) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:simple_array)\', first_name VARCHAR(50) DEFAULT NULL, last_name VARCHAR(50) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE rent_periods ADD CONSTRAINT FK_863BE3D2D4619D1A FOREIGN KEY (listing_id) REFERENCES listings (id) ON DELETE CASCADE');
    }
